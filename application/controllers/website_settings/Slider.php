<?php class Slider extends Admin_Controller{
    ...
    public function index() {
        ...
        $this->load->view('components/website_settings/slider/list', $this->data);
    ...
    public function add() {
        ...
        $this->load->view('admin/includes/headermenu', $this->data);
        $this->load->view('admin/includes/nav', $this->data);
        $this->load->view('components/website_settings/slider/add', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    ...
    public function edit($id=null) {
        ...
        $this->load->view('admin/includes/headermenu', $this->data);
        $this->load->view('admin/includes/nav', $this->data);
        $this->load->view('components/website_settings/slider/edit', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    ...
    public function trash_list(){
        ...
        $this->load->view('admin/includes/headermenu', $this->data);
        $this->load->view('admin/includes/nav', $this->data);
        $this->load->view('components/website_settings/slider/trash_list', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
