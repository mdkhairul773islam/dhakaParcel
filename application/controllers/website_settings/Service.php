<?php class Service extends Admin_Controller{
    ...
    public function index(){
        ...
        $this->load->view('components/website_settings/service/add', $this->data);
    ...
    public function all_view(){
        ...
        $this->load->view('admin/includes/headermenu', $this->data);
        $this->load->view('admin/includes/nav', $this->data);
        $this->load->view('components/website_settings/service/list', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
    ...
    public function edit($id=null){
        ...
        $this->load->view('admin/includes/headermenu', $this->data);
        $this->load->view('admin/includes/nav', $this->data);
        $this->load->view('components/website_settings/service/edit', $this->data);
        $this->load->view('admin/includes/footer', $this->data);
    }
