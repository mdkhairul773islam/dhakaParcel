        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form method="post" action="<?php echo site_url('system_privilege/PrivilegeController/process'); ?>">
                    ...
                    <div class="panel-group" id="accordion_<?php echo $user_key; ?>" role="tablist"
                        aria-multiselectable="false">
                        <div class="panel panel-default">
                            <div class="" role="tab" id="headingOne_<?php echo $user_key; ?>">
                                <div class="panel-title">
                                    <a role="button" data-toggle="collapse"
                                        data-parent="#accordion_<?php echo $user_key; ?>"
                                        href="#collapseOne_<?php echo $user_key; ?>" aria-expanded="true"
                                        ...
                                        <div>
                                            <table class="tabel">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>: </th>
                                                    <td> &nbsp;
                                                        <?php echo ucfirst($user_value->privilege); ?>
                                                        <?php /*
                            ...
                            <div id="collapseOne_<?php echo $user_key; ?>" class="panel-collapse collapse out"
                                role="tabpanel" aria-labelledby="headingOne_<?php echo $user_key; ?>">
                                <div class="panel-body">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <label class="switch">
                                                        <input type="checkbox"
                                                            <?php echo (!empty($aside_menu_array) && in_array($p_aside_menus_value->id, $aside_menu_array)) ? 'checked' : ''; ?>
                                                            value="<?php echo $p_aside_menus_value->id;?>"
                                                            name="aside_menu_id[]">
                                                        <span></span>
                                        ...
                                        ?>
                                                <div>
                                                    <label class="switch" style="margin: 0.4rem 0">
                                                        <input type="checkbox"
                                                            <?php echo (!empty($aside_dropdown_menu_array) && in_array($p_menus_dropdown_value->id, $aside_dropdown_menu_array)) ? 'checked' : ''; ?>
                                                            value="<?php echo $p_menus_dropdown_value->id;?>"
                                        ...
                                        ?>
                                                <div>
                                                    <label class="switch" style="margin: 0.4rem 0">
                                                        <input type="checkbox"
                                                            <?php echo (!empty($action_menu_array) && in_array($p_action_menu_value->id, $action_menu_array)) ? 'checked' : ''; ?>
                                                            value="<?php echo $p_action_menu_value->id;?>"
                                                            name="action_menu_id[]">
                                                        <span></span>
                                    ...
                                    <input type="submit"
                                        value="<?php echo (!empty($aside_menu_array)) ? "Update" : "Save"; ?>"
                                        name='<?php echo (!empty($aside_menu_array)) ? "update" : "save"; ?>'
