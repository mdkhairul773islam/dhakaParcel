    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php msg(); ?>
                <form action="<?php echo get_url("sister_concern/sister_concern/add_process"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="url" placeholder="Enter url: https://www.google.com..." class="form-control" required>
                        </div>
                    </div>
