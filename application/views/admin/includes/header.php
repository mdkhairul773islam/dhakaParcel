...
<head>
    ...
    <script type="text/javaScript"
        src="<?php echo site_url('private/plugins/bootstrap-datetimepicker-master/build/js/bootstrap-datetimepicker.min.js') ;?>">
    </script>
    ...
    #wrapper.dark_linear .sidebar-nav>li.active {
        background: linear-gradient(60deg, #536272 0%, #333f4b 100%);
    }
    ...
    #wrapper.dark_linear .sidebar-nav li a:hover {
        background: linear-gradient(60deg, #5d6e80 0%, #3e4b5a 100%);
    }

    #wrapper.dark_linear .content-fixed-nav,
    #wrapper.dark_linear h3.sidebar-brand,
    #wrapper.dark_linear .sidebar-nav {
        background: linear-gradient(60deg, #29323c 0%, #485563 100%);
    }

    #wrapper.dark_linear .content-fixed-nav>ul>li>a,
    #wrapper.dark_linear .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.dark_linear .sidebar-nav>li.active>a,
    #wrapper.dark_linear .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.dark_linear .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    #wrapper.dark .sidebar-nav>li.active {
        background: #454b60;
    }
    ...
    #wrapper.dark .sidebar-nav li a:hover {
        background: #4f566f;
    }

    #wrapper.dark .content-fixed-nav,
    #wrapper.dark h3.sidebar-brand,
    #wrapper.dark .sidebar-nav {
        background: #3A3F51;
    }

    #wrapper.dark .content-fixed-nav>ul>li>a,
    #wrapper.dark .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.dark .sidebar-nav>li.active>a,
    #wrapper.dark .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.dark .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    #wrapper.light_linear .sidebar-nav>li.active {
        background: linear-gradient(60deg, #9f89df 0%, #8a92f7 100%);
    }
    ...
    #wrapper.light_linear .sidebar-nav li a:hover {
        background: linear-gradient(60deg, #b09de5 0%, #a2a8f8 100%);
    }

    #wrapper.light_linear .content-fixed-nav,
    #wrapper.light_linear h3.sidebar-brand,
    #wrapper.light_linear .sidebar-nav {
        background: linear-gradient(135deg, #8f75da 0, #727cf5 60%);
    }

    #wrapper.light_linear .content-fixed-nav>ul>li>a,
    #wrapper.light_linear .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.light_linear .sidebar-nav>li.active>a,
    #wrapper.light_linear .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.light_linear .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    #wrapper.light .sidebar-nav>li.active {
        background: #9f89df;
    }
    ...
    #wrapper.light .sidebar-nav li a:hover {
        background: #b09de5;
    }

    #wrapper.light .content-fixed-nav,
    #wrapper.light h3.sidebar-brand,
    #wrapper.light .sidebar-nav {
        background: #8f75da;
    }

    #wrapper.light .content-fixed-nav>ul>li>a,
    #wrapper.light .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.light .sidebar-nav>li.active>a,
    #wrapper.light .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.light .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    #wrapper.night_linear .sidebar-nav>li.active {
        background: linear-gradient(60deg, #b09ed8 0%, #fddaf3 100%);
    }
    ...
    #wrapper.night_linear .sidebar-nav li a:hover {
        background: linear-gradient(60deg, #bfb0e0 0%, #fef2fb 100%);
    }

    #wrapper.night_linear .content-fixed-nav,
    #wrapper.night_linear h3.sidebar-brand,
    #wrapper.night_linear .sidebar-nav {
        background: linear-gradient(to top, #a18cd1 0%, #fbc2eb 100%);
    }

    #wrapper.night_linear .content-fixed-nav>ul>li>a,
    #wrapper.night_linear .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.night_linear .sidebar-nav>li.active>a,
    #wrapper.night_linear .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.night_linear .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    #wrapper.night .sidebar-nav>li.active {
        background: #b09ed8;
    }
    ...
    #wrapper.night .sidebar-nav li a:hover {
        background: #bfb0e0;
    }

    #wrapper.night .content-fixed-nav,
    #wrapper.night h3.sidebar-brand,
    #wrapper.night .sidebar-nav {
        background: #a18cd1;
    }

    #wrapper.night .content-fixed-nav>ul>li>a,
    #wrapper.night .sidebar-nav li a {
        color: #eee;
    }

    #wrapper.night .sidebar-nav>li.active>a,
    #wrapper.night .sidebar-nav>.sidebar-brand a {
        color: #fff;
    }

    #wrapper.night .content-fixed-nav>ul>li>a span {
        color: #fff !important;
    }
    ...
    <div id="wrapper" class="<?=($theme ? $theme[0]->meta_value:'')?>">
        ...
        if (colors) Object.values(colors).forEach(color => {
            ...
            color.addEventListener('click', () => {
                ...
                axios.post(url + 'Ajax/save_theme', makeFormData({
                        theme: newClass
                    }))
                    .then(response => {})
